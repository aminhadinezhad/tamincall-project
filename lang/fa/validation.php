...
// Generated from the main Tamin Falat site's lang/fa/validation.php, with half-spaces replaced by spaces.
...
return [
    ...
    'captcha' => 'آزمون متنی همگانی با عکس تطابق ندارد.',
    ...
    'max_digits' => 'فیلد :attribute می بایست بیشتر از :max کرکتر عددی باشد.',
    'custom' => [
    ],
    'attributes' => [
    ],
