...
// Generated from vendor/filament/filament/resources/lang/fa/auth/pages/edit-profile.php, with half-spaces replaced by spaces.
...
return [
  ...
  [
    ...
    'throttled' => 
    [
      'title' => 'تعداد درخواست ها بیش از حد مجاز است. لطفاً :seconds ثانیه دیگر دوباره تلاش کنید.',
      'body' => 'لطفاً :seconds ثانیه دیگر دوباره تلاش کنید.',
    ],
  ],
  'actions' => 
  [
